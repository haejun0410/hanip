...
export const hanbeoteamNotices = {
  ...
  general: [
    { emoji: '🤖', text: 'AI가 취학 전 자녀의 교육비 결제 내역을 추가 공제 후보로 찾았어요.', date: '오늘' },
...
export const hanbeoteamAiBenefits: AiBenefit[] = [
  {
    ...
    conditions: ['홑벌이 가구 기준 총소득 3,200만원 미만인가요?', '부양자녀가 있는 가구인가요?', '재산 합계 2억 4천만원 미만인가요?'],
  },
  {
    id: 'single-parent-ai',
    type: 'tax',
    ...
    conditions: ['현재 배우자가 없나요?', '기본공제 대상 자녀가 있나요?', '기존 부녀자 공제 적용 여부를 확인하셨나요?'],
  },
  {
    id: 'care-ai',
    type: 'policy',
  ...
  },
  {
    ...
    icon: '🎨',
    iconBg: '#EDE9FE',
    title: '취학 전 아동 교육비 결제',
    subtitle: '교육비 세액공제 후보',
    statusLabel: '누락 가능성',
    statusColor: '#D97706',
    amount: 300000,
    amountLabel: '공제 가능 금액',
    aiReason: '카드 내역에서 취학 전 자녀의 학원·체육시설 결제가 감지됐어요. 연말정산 간소화에 반영되지 않는 경우가 있습니다.',
    conditions: ['취학 전 자녀의 학원·체육시설 수강료인가요?', '영수증이 있나요?', '간소화 서비스에서 조회되나요?'],
  },
]
